...
import BountyLeaderboardPage from "../knockout-leaderboard/page";
...
export default function PokerPage() {
  ...
  return (
    ...
    >
      ...
      {activeTab === 0 && (
        <Box>
          <SectionTitle size="large">Poker Rules</SectionTitle>

          <Stack spacing={1.5} mb={4}>
            <Typography>
              <strong>Objective:</strong> Win chips by either having the best hand
              at showdown or by making other players fold.
            </Typography>
            <Typography>
            ...
            <Typography>
              <strong>Community Cards:</strong> 5 cards are placed face up on the table
              (shared by all players).
            </Typography>
          </Stack>

          <SectionTitle size="large">Game Flow</SectionTitle>
          ...
          <SectionTitle size="large">Basic Actions</SectionTitle>
      ...
      {activeTab === 3 && (
        <Box>
          <SectionTitle size="large">Texas Hold’em Starting Hands</SectionTitle>
          ...
          <Stack spacing={1} mb={3}>
            ...
            <Stack spacing={1} mt={5} mb={5}>
              <SectionTitle size="medium">Texas Hold’em Hands</SectionTitle>
