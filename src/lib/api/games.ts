...
import {  Game, GameDetails, GamePanel, GameType, HallOfFameEntry, GameHistoryEntry, ActivePlayerGame, GameListItemDto  } from "@/lib/models/game";
...
export const getAllGames = () =>
  apiFetch<GameListItemDto[]>(`/games`);
